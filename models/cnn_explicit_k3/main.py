...
def denoiser_train(denoiser, lr):
    ...
    noisy_data = np.load('../../model_input/osa_homo_hetero/noisy_pats.npy')
    clean_data = np.load('../../model_input/osa_homo_hetero/clean_pats.npy')
    ...
    print("min : {} (noisy)\t {} (clean)\n".format(np.amin(noisy_data), np.amin(clean_data)))
