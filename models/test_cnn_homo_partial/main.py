...
def denoiser_train(denoiser, lr):
    ...
    noisy_data = np.load('../../model_input/rand2d_homo_partial/rand2d_noisy_pats_1e+04.npy')
    clean_data = np.load('../../model_input/rand2d_homo_partial/rand2d_clean_pats_1e+04.npy')
