function [cw, myimg, cfg]=rand_2d_mcx(nphoton, maxprop, imsize, randseed, srcPos)
%
% Format:
%   [cw, myimg, cfg]=rand_2d_mcx(nphoton, maxprop, imsize, randseed, srcPos)
% 
...
cfg.srcpos=[0 srcPos(1) srcPos(2)];
