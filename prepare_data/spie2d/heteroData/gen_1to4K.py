...
def gen_data(startpos = None, endpos = None, batch_size = 64, im_w = 100, im_h = 100,
        data_dir  ='../../../data/spie2d/het',  # note: modify here
        save_dir = None):
    '''
    ...
    np.save(os.path.join(save_dir, "1to4K_1e4"), inputs_1e4)
    np.save(os.path.join(save_dir, "1to4K_1e5"), inputs_1e5)
    np.save(os.path.join(save_dir, "1to4K_1e6"), inputs_1e6)
    np.save(os.path.join(save_dir, "1to4K_1e7"), inputs_1e7)
    np.save(os.path.join(save_dir, "1to4K_1e8"), inputs_1e8)
...
if __name__ == '__main__':
    ...
    print '\nGenerating rand2d heterogeneous data.'
    gen_data(startpos = 1, endpos = 4000, save_dir='../../../model_input/spie2d/het')
