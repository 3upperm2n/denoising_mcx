...
currentImage = cwdata; feval('save', 'square_1e6.mat', 'currentImage');

[cwdata1, imgdata1, ~] = rand_2d_mcx_grid_test(1e7, img_modify, 123, mcxseed);
subplot(2,2,3);
imagesc(log10(abs(cwdata1))); colorbar;
currentImage = cwdata; feval('save', 'square_1e7.mat', 'currentImage');


[cwdata1, imgdata1, ~] = rand_2d_mcx_grid_test(1e8, img_modify, 123, mcxseed);
subplot(2,2,4);
imagesc(log10(abs(cwdata1))); colorbar;
currentImage = cwdata; feval('save', 'square_1e8.mat', 'currentImage');
...
subplot(2,2,2);
imagesc(log10(abs(cwdata1))); colorbar;
currentImage = cwdata; feval('save', 'square02_1e6.mat', 'currentImage');

[cwdata1, imgdata1, ~] = rand_2d_mcx_grid_test(1e7, img_modify, 123, mcxseed);
subplot(2,2,3);
imagesc(log10(abs(cwdata1))); colorbar;
currentImage = cwdata; feval('save', 'square02_1e7.mat', 'currentImage');


[cwdata1, imgdata1, ~] = rand_2d_mcx_grid_test(1e8, img_modify, 123, mcxseed);
subplot(2,2,4);
imagesc(log10(abs(cwdata1))); colorbar;
currentImage = cwdata; feval('save', 'square02_1e8.mat', 'currentImage');
