...
# 
#------------------------------------------------------------------------------
def gen_data(photon_vol='1e+04', batch_size = 64, im_w = 100, im_h = 100,
                 data_dir='../../data/spie2d/hom',
                 clean_dir ='../../data/spie2d/hom/1e+07',
                 clean_prefix='test',
                 save_dir = '../../model_input/spie2d/'):
    '''
    ...
    np.save(os.path.join(save_dir, "hom_1e4"), inputs_noisy)
    np.save(os.path.join(save_dir, "hom_1e7"), inputs_clean)
