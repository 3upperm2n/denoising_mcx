...
def denoiser_test(denoiser):
    ...
    input_noisy[0, :, :, :] = mat2np('../../data/spie2d/het/1e+04/test4001.mat', maxV=maxV, im_h=im_h, im_w=im_w)
    input_noisy[1, :, :, :] = mat2np('../../data/spie2d/het/1e+05/test4001.mat', maxV=maxV, im_h=im_h, im_w=im_w)
    input_noisy[2, :, :, :] = mat2np('../../data/spie2d/het/1e+06/test4001.mat', maxV=maxV, im_h=im_h, im_w=im_w)
    input_noisy[3, :, :, :] = mat2np('../../data/spie2d/het/1e+07/test4001.mat', maxV=maxV, im_h=im_h, im_w=im_w)
    ...
    input_noisy[0, :, :, :] = mat2np('../../data/spie2d/hom/1e+04/test2001.mat', maxV=maxV, im_h=im_h, im_w=im_w)
    input_noisy[1, :, :, :] = mat2np('../../data/spie2d/hom/1e+05/test2001.mat', maxV=maxV, im_h=im_h, im_w=im_w)
    input_noisy[2, :, :, :] = mat2np('../../data/spie2d/hom/1e+06/test2001.mat', maxV=maxV, im_h=im_h, im_w=im_w)
    input_noisy[3, :, :, :] = mat2np('../../data/spie2d/hom/1e+07/test2001.mat', maxV=maxV, im_h=im_h, im_w=im_w)
