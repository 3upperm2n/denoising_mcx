...
def denoiser_test(denoiser):
    ...
    # 1e5
    #-------#
    snr_dat = get_snr_data(snr_dir + '/journal2_50ns_vol100_absorber3_1e5_pack1.mat')  # return 100 x (100x100)
    ...
    denoiser.test(input_dat, ckpt_dir=args.ckpt_dir, outFile='snr_absorb1e5_nn.mat')
